            ...
            <div class="container">
                <div class="card mb-4">
                    <div class="mapouter"><div class="gmap_canvas"><iframe width="310" height="150" id="gmap_canvas" src="https://maps.google.com/maps?q=Parking%20Avenue%20Mohammed%20V&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://fmovies-online.net">fmovies</a><br><style>.mapouter{position:relative;text-align:right;height:150px;width:310px;}</style><a href="https://www.embedgooglemap.net">google embed map</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:150px;width:310px;}</style></div></div>
                        ...
                        <div class="card-body" >
                            <h6> Number of empty places: 15</h6>
                        </div>
                        <hr style="margin-top: -20px; margin-bottom: -5px;">
                        <div class="card-body" >
